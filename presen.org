...
+ Std MCTS has been bad
#+end_xlarge
#+end_center

** GBFS */can/* be seen as MCTS (Keller et al. 2013)
...
* Experiments! International Planning Competition (IPC) benchmark set :noexport:
...
#+end_span6
#+begin_span6
Various domains from the industry

Test the *general* performance
#+end_span6
#+end_row-fluid
#+end_container-fluid

** Experiments! International Planning Competition (IPC) benchmark set
...
We excluded some domains:

+ with incompatible extensions (not supported by pyperplan)
+ with no heuristic uncertainty (randomization does not affect FF heuristic)
#+end_span6
#+end_row-fluid
#+end_container-fluid

* Baseline Experiments                                             :noexport:

*Task:* Find the goal while *visiting as few nodes as possible!*

+ Node expansions == search efficiency
+ Not the speed (runtime) *yet*
  + We will optimize them later by reimplementing it in C++
  + *but*, generally $\text{runtime} \propto \text{expansion}$
...
+ Standard GBFS (Greedy Best First Search) :: Standard implementation
  + Standard FF vs Randomized FF (1 seed)
+ Tree-based GBFS :: MCTS with $h(s_i)$, backup statistics: minimum among arms
  + Standard FF vs Randomized FF (10 seeds mean)
  + Standard FF vs Randomized FF (10 seeds minimum)
+ Bounded UCB (Keller's butchered UCB1) :: $\frac{h(s_i)-\min_j h(s_j)}{\max_j h(s_j)-\min_j h(s_j)}-c\sqrt{{\log N}/{n_i}}$
  + It needs an exploration hyperparameter $c\in \{0.3,1.0,3.0\}$
+ UCB1-Normal :: $h(s_i)-\sigma_i \sqrt{\log N}$
  + Theoretically justified + No need for a hyperparameter

** Standard GBFS Std FF vs Rand FF : Rand wins (interesting result!)

[[spng:plots/expansions__gbfs-False-10-0.2-inf-0.5-False__gbfs-True-10-0.2-inf-0.5-False]]

** Tree-based GBFS Std FF vs Rand FF (10 seeds mean) : Std wins (interesting result!)

[[spng:plots/expansions__GBFSMean-False-10-0.2-inf-0.5-False__GBFSMean-True-10-0.2-inf-0.5-False]]

** Tree-based GBFS Std FF vs Rand FF (10 seeds minimum) : Rand wins (Significant result!)

[[spng:plots/expansions__GBFSMin-False-10-0.2-inf-0.5-False__GBFSMin-True-10-0.2-inf-0.5-False]]

** Tree-based GBFS Std FF vs Rand FF (10 seeds maximum) : Std wins (interesting result!)

[[spng:plots/expansions__GBFSMax-False-10-0.2-inf-0.5-False__GBFSMax-True-10-0.2-inf-0.5-False]]

** Is Standard GBFS == Tree-Based GBFS? (Reproducing Keller's claims)
...
[[spng:plots/expansions__gbfs-False-10-0.2-inf-0.5-False__GBFSMean-False-10-0.2-inf-0.5-False]]
...
[[spng:plots/expansions__gbfs-True-10-0.2-inf-0.5-False__GBFSMin-True-10-0.2-inf-0.5-False]]
#+end_center
#+end_span4
#+begin_span4
#+begin_center
...
[[spng:plots/expansions__gbfs-True-10-0.2-inf-0.5-False__GBFSMean-True-10-0.2-inf-0.5-False]]
#+end_center
#+end_span4
#+end_row-fluid
#+end_container-fluid

** Standard GBFS vs Bounded UCB (Keller's butchered UCB1) (Reproducing Keller's claims)

#+begin_container-fluid
#+begin_row-fluid
#+begin_span4
#+begin_center
*Even in the original paper*, his butchered UCB1 did not perform good

[[spng:keller-gbfs-ucb1]]
#+end_center
#+end_span4
#+begin_span4
#+begin_center
Std FF: Butchered UCB1 is *BAD*

[[spng:plots/expansions__gbfs-False-10-0.2-inf-0.5-False__BoundedUCT-False-10-0.2-inf-0.5-False]]
#+end_center
#+end_span4
#+begin_span4
#+begin_center
Rand FF: Butchered UCB1 is *BAD*

[[spng:plots/expansions__gbfs-True-10-0.2-inf-0.5-False__BoundedUCT-True-10-0.2-inf-0.5-False]]
#+end_center
#+end_span4
#+end_row-fluid
#+end_container-fluid

** Standard GBFS vs UCB1-Normal (Significant result!)

#+begin_container-fluid
#+begin_row-fluid
#+begin_span6
#+begin_center
Std FF: UCB1-Normal wins

[[spng:plots/expansions__gbfs-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-inf-0.5-False]]

#+end_center
#+end_span6
#+begin_span6
#+begin_center
Rand FF: GBFS wins (surprising)

[[spng:plots/expansions__gbfs-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-inf-0.5-False]]
...
** Bounded UCB vs UCB1-Normal (Significant result!)
...
[[spng:plots/expansions__BoundedUCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-inf-0.5-False]]

#+end_center
#+end_span6
#+begin_span6
#+begin_center
Rand FF: UCB1-Normal wins

[[spng:plots/expansions__BoundedUCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-inf-0.5-False]]
...
+ Std GBFS : Std FF vs *Rnd FF* (significant result)
+ Tree-GBFS : Std FF vs *Rnd FF* (significant result)
+ Std FF : Tree-GBFS vs Std GBFS -- on par (Keller's claim)
+ Rnd FF : Tree-GBFS vs Std GBFS -- on par (Keller's claim+)
+ Std FF  : *Std GBFS* vs Bounded UCB (Keller's claim)
+ Rnd FF : *Std GBFS* vs Bounded UCB (Keller's claim+)
+ Std FF  : Std GBFS vs *UCB1-Normal* (significant result)
+ Rnd FF : *Std GBFS* vs UCB1-Normal (significant result)
+ Std FF  : Bounded UCB vs *UCB1-Normal* (significant result)
+ Rnd FF : Bounded UCB vs *UCB1-Normal* (significant result)

Alright, it seems we no longer have to worry about the buchered UCB.



* Baseline Experiments 2                                           :noexport:

Next, we test more UCB variants.

+ Bounded UCB1 :: $\frac{h(s_i)-\min_j h(s_j)}{\max_j h(s_j)-\min_j h(s_j)}-c\sqrt{{\log N}/{n_i}}$
  + It needs an exploration hyperparameter $c\in \{0.3,1.0,3.0\}$
+ UCB1 :: $h(s_i)-c\sqrt{{\log N}/{n_i}}$
  + It needs an exploration hyperparameter $c\in \{0.3,1.0,3.0\}$
+ UCB1-Normal :: $h(s_i)-\sigma_i \sqrt{\log N}$
  + Theoretically justified + No need for a hyperparameter

** Butchered UCB1 vs UCB1
...
[[spng:plots/expansions__BoundedUCT-False-10-0.2-0.3-0.5-False__UCT-False-10-0.2-0.3-0.5-False]]
...
[[spng:plots/expansions__BoundedUCT-False-10-0.2-1.0-0.5-False__UCT-False-10-0.2-1.0-0.5-False]]
...
[[spng:plots/expansions__BoundedUCT-False-10-0.2-3.0-0.5-False__UCT-False-10-0.2-3.0-0.5-False]]
...
[[spng:plots/expansions__BoundedUCT-True-10-0.2-0.3-0.5-False__UCT-True-10-0.2-0.3-0.5-False]]
...
[[spng:plots/expansions__BoundedUCT-True-10-0.2-1.0-0.5-False__UCT-True-10-0.2-1.0-0.5-False]]
...
[[spng:plots/expansions__BoundedUCT-True-10-0.2-3.0-0.5-False__UCT-True-10-0.2-3.0-0.5-False]]
...
Bounded UCB $\approx\,$ UCB $\gg\,$ UCB1-Normal → There is *something* in UCB1-Normal

* */One/* reason: Poor understanding. @@html:<br>@@\rightarrow UCB1 to */UCB1-Normal/*

#+begin_quote
| UCB1        | $h(s_i)-c\sqrt{\frac{\log N}{n_i}}$  |
| UCB1-Normal | $h(s_i)-\sigma_i \sqrt{\log N}\quad$ |

#+begin_center
$N$: parent visit, $n_i$: visit for child $i$

$h(s_i), \sigma_i$ : mean / stdev over the subtree of $i$
#+end_center
#+end_quote
...
$\frac{c}{\sqrt{n_i}}\rightarrow \sigma_i$ : *Adjusts the exploration rate* toward the goal
...
(stat fact: $\sigma\approx O(n^{-\frac{1}{2}})$)

* Different $c$ of UCB vs UCB1-Normal                              :noexport:
...
[[spng:plots/expansions__UCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-0.01-0.5-False]]
...
[[spng:plots/expansions__UCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-0.3-0.5-False]]
...
[[spng:plots/expansions__UCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-1.0-0.5-False]]
...
[[spng:plots/expansions__UCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-3.0-0.5-False]]
...
[[spng:plots/expansions__UCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-0.01-0.5-False]]
...
[[spng:plots/expansions__UCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-0.3-0.5-False]]
...
[[spng:plots/expansions__UCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-1.0-0.5-False]]
...
[[spng:plots/expansions__UCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-3.0-0.5-False]]
...
Smaller $c$ is better, but not enough. Automatic scaling ($\sigma$) is the key
...
* Avg. vs. Min. = Different Backup strategy
...
+ *Are heuristic samples $\in[-\infty,\infty]$ ? /No!/*
...
[[png:candidate-distribution]]

** What distribution is the right answer?

In optimization problems, */good solutions are rare/*.
...
*Good solutions are rare*. == */Monotonically increasing./*
...
* But Why? */What theory/* justifies this?
...
| *UCB1-Power*   | _/Known/_ $0$      | */Unknown/* $u$ | */Rare near maximum/* |


#+begin_quote
(GPD: 3-parameters, Uniform/Power: 2-parameters)
#+end_quote

* Results: UCB1-Uniform vs GBFS

*IPC 2008 Cybersec(urity) domain results* solved by both.
...
[[spng:plots-cyber/expansions__UniformUCT-hff-False-10-0.2-inf-0.5-False__gbfs-hff-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-cyber/expansions__UniformUCT-hff-True-10-0.2-inf-0.5-False__GBFSMin-hff-True-10-0.2-inf-0.5-False]]
...
*Upper triangle == Ours is better.*  (conclusive win)

** Results: UCB1-Uniform vs UCB1-Normal
...
[[spng:plots-cyber/expansions__UniformUCT-hff-False-10-0.2-inf-0.5-False__UCT-hff-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-cyber/expansions__UniformUCT-hff-True-10-0.2-inf-0.5-False__UCT-hff-True-10-0.2-inf-0.5-False]]
...
[[spng:plots-cyber/expansions__PowerUCT-hff-False-10-0.2-inf-0.5-False__gbfs-hff-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-cyber/expansions__PowerUCT-hff-True-10-0.2-inf-0.5-False__GBFSMin-hff-True-10-0.2-inf-0.5-False]]
...
** Results: UCB1-Power vs UCB1-Normal
...
[[spng:plots-cyber/expansions__PowerUCT-hff-False-10-0.2-inf-0.5-False__UCT-hff-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-cyber/expansions__PowerUCT-hff-True-10-0.2-inf-0.5-False__UCT-hff-True-10-0.2-inf-0.5-False]]
...
* Conclusion : */Power & Uniform UCT/* > _/GBFS & MCTS/_

+ *GBFS* : *Traditional SotA* in planning, basis of newer enhancements
+ UCB1 : _/never outperformed/_ GBFS
+ UCB1-Normal : _/comparable/_, _/inconclusive/_ vs. GBFS
+ *UCB1-Uniform/Power* : */Clearly outperformed/ GBFS* for the 1st time!

*Key Takeaway*:

+ */Fundamental theory/* for *all /optimization/ problems*:

  By definition, nothing beats the optima! \rightarrow *min/max*, *finite support*

+ *Future work for publication* (outside the core focus of this project):

  C++ reimplementation

  #+begin_smaller
  Apply existing enhancements to GBFS
  + Delayed Heuristic Evaluation DHE
  + Preferred Operator
  + Diversified Best First Search (DBFS), Type-GBFS, $\epsilon$-greedy GBFS
...
*All IPC domain results* solved by both.
...
[[spng:plots-new/expansions__UniformUCT-False-10-0.2-inf-0.5-False__gbfs-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__UniformUCT-True-10-0.2-inf-0.5-False__GBFSMin-True-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__UniformUCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__UniformUCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__PowerUCT-False-10-0.2-inf-0.5-False__gbfs-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__PowerUCT-True-10-0.2-inf-0.5-False__GBFSMin-True-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__PowerUCT-False-10-0.2-inf-0.5-False__UCT-False-10-0.2-inf-0.5-False]]
...
[[spng:plots-new/expansions__PowerUCT-True-10-0.2-inf-0.5-False__UCT-True-10-0.2-inf-0.5-False]]
