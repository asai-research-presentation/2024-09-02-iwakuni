...
+ */1つの変更で全部が影響受ける/*
  + なぜ性能良くなったのか、わからなくない?
+ */再現性の問題も、ある.../*
  + Leslie Kaelbring: RLの評価は最低20シードないと認めない！
+ _/The science/_ as a *sane* researcher:
  + _/Split/_ the architecture into parts
  + _/Study each part individually/_
  + _/Correct mathematical modeling/_
  + こういうアプローチに立ち返るのがいいと思います...
#+end_span7
#+end_row-fluid
#+end_container-fluid

* LLM + Planning (, Reasoning) が成功するには?
...
+ 全部一度にこなそうとしている
  + *表現学習* : ここだけはとても汎化している
  + *探索* : 全くしていない(Reflex Agent) か 非常に原始的 (CoT)
  + *ヒューリスティクス* : 「常識」の丸暗記
+ プランニングに対する *解像度* が低い
